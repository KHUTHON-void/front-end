...
import { deleteComment, deletePost, editComment, getCommentList, postComment } from '../utils/axios'
            ...
            {comment.commentId === editingCommentId ? (
              ...
              <CommentOutlay>
                <Comment> 
                  ...
                  <EditCommentButton onClick={() => navigate(`/videochat`)}>만나보기</EditCommentButton>
                </Comment>
              </CommentOutlay>
            )}
          </div>
